...
def test_api_success(mock_get, client):
    # Simule une réponse binaire de PointSetManager avec 3 points
    mock_get.return_value.status_code = 200
    mock_get.return_value.content = b'\x03\x00\x00\x00\x00\x00\x00\x00\x00\x00\x80?\x00\x00\x00\x00\x00\x00\x00@\x00\x00@@'
